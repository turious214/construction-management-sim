...
export default class BridgeProject {
    ...
    private _riskMitigationTools: Map<string, RiskMitigationTool>

    constructor(funds: number, tasks: Map<number, Task>, weeks: Week[], contractors: Map<number, Contractor>, materials: Map<string, Material>, events: Map<number, Event>, riskMitigationTools: Map<string, RiskMitigationTool>) {
        this._funds = funds;
        this._tasks = tasks;
        this._weeks = weeks;
