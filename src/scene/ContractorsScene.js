...
class ContractorsScene extends Phaser.Scene {
    ...
    create() {
        ...
        // add exist button
        const exitButton = new CustomButton_1.default(this, INIT_MAIN_UI_X * 8, INIT_MAIN_UI_Y * 20, 'button1Normal', 'button1Hover', 'Exit', 30);
        ...
        let middleHeading = new CustomButton_1.default(this, card.x, 150, 'button1Normal', 'button1Hover', 'Electricians', 30).setScale(1.2, 1.2);
        this.add.existing(middleHeading);
        let leftHeading = new CustomButton_1.default(this, middleHeading.x - middleHeading.width - HEADING_DIST, 150, 'button1Normal', 'button1Hover', 'Plumbers', 30).setScale(0.75, 0.75);
        this.add.existing(leftHeading);
        let rightHeading = new CustomButton_1.default(this, middleHeading.x + middleHeading.width + HEADING_DIST, 150, 'button1Normal', 'button1Hover', 'Plasterers', 30).setScale(0.75, 0.75);
        ...
        for (let i = 0; i < infoNum; i++) {
            ...
            clickArea.setInteractive(areaCheck1, Phaser.Geom.Rectangle.Contains)
                ...
                if (Phaser.Geom.Rectangle.Contains(areaCheck2, pointer.x, pointer.y)) {
                    ...
                    price.destroy();
                    clickArea.destroy();
                    this.createWindow(TaskAssignmentScene_1.TaskAssignmentScene);
                }
            }, this);
    ...
    shiftHeading(leftHeading, middleHeading, rightHeading, direction, cardxPos, HEADING_DIST) {
        ...
        // make new buttons
        middleHeading = new CustomButton_1.default(this, cardxPos, 150, 'button1Normal', 'button1Hover', `${this.contractors[this.contractorsWindow[1]]}`, 30).setScale(1.2, 1.2);
        this.add.existing(middleHeading);
        leftHeading = new CustomButton_1.default(this, middleHeading.x - middleHeading.width - HEADING_DIST, 150, 'button1Normal', 'button1Hover', `${this.contractors[this.contractorsWindow[0]]}`, 30).setScale(0.75, 0.75);
        this.add.existing(leftHeading);
        rightHeading = new CustomButton_1.default(this, middleHeading.x + middleHeading.width + HEADING_DIST, 150, 'button1Normal', 'button1Hover', `${this.contractors[this.contractorsWindow[2]]}`, 30).setScale(0.75, 0.75);
        this.add.existing(rightHeading);
    }
...
exports.ContractorsScene = ContractorsScene;
