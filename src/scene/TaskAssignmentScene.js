...
export class TaskAssignmentScene extends Phaser.Scene {
    ...
    generateContent(INIT_MAIN_UI_X, INIT_MAIN_UI_Y, CONTENT_BUFFER_X, HEADING_SPACE_Y, tasks, clickAreas, infoNum) {
