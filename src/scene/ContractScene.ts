...
import EstimatePointSet from "./EstimatePointSet.ts";

let INIT_MAIN_UI_X: number = 200;
let INIT_MAIN_UI_Y: number = 50;
...
export default class ContractScene extends Phaser.Scene {
    ...
    private contractors: string[] = ['OBS', 'CBS', 'WBS'];
    private contractorsWindow: number[] = [0, 1, 2];
    ...
    shiftHeading(leftHeading: CustomButton, middleHeading: CustomButton, rightHeading: CustomButton, direction: string, cardxPos: number, HEADING_DIST: number) {
